 ...
 *
 * GPX support:
 *   - <trkpt> elements with lat/lon attributes
 *   - <ele> child → elevation
 *   - <time> child → timestamp
 *   - Garmin TrackPointExtension: <power>, <hr>, <cad>
 *
 * TCX support:
 *   - <Trackpoint> elements
 *   - <Position> child with <LatitudeDegrees> / <LongitudeDegrees>
 *   - <AltitudeMeters>, <Time>, <HeartRateBpm><Value>, <Cadence>
 *   - <Extensions><TPX><Watts> for power
 */
